...
type ComplexityRoot struct {
	...
	User struct {
		...
		DiscordName func(childComplexity int) int
		ID          func(childComplexity int) int
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "User.discordName":
		if e.complexity.User.DiscordName == nil {
			break
		}

		return e.complexity.User.DiscordName(childComplexity), true
...
func (ec *executionContext) field_Mutation_createUser_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNNewUser2serverᚋgraphᚋmodelᚐNewUser(ctx, tmp)
	}
...
func (ec *executionContext) fieldContext_Message_user(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "discordName":
				return ec.fieldContext_User_discordName(ctx, field)
			}
...
func (ec *executionContext) _User_discordName(ctx context.Context, field graphql.CollectedField, obj *model.User) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_User_discordName(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_User_discordName(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "User",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) unmarshalInputNewUser(ctx context.Context, obj any) (model.NewUser, error) {
	...
	fieldsInOrder := [...]string{"discordId", "discordName", "pictureUrl"}
	for _, k := range fieldsInOrder {
		...
		case "discordId":
			...
			it.DiscordID = data
		case "discordName":
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("discordName"))
...
func (ec *executionContext) _User(ctx context.Context, sel ast.SelectionSet, obj *model.User) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "discordName":
			out.Values[i] = ec._User_discordName(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		default:
...
func (ec *executionContext) unmarshalNNewUser2serverᚋgraphᚋmodelᚐNewUser(ctx context.Context, v any) (model.NewUser, error) {
